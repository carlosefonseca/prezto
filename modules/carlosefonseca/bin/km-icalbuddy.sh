...
# Date:	2020-05-09
	...
	# CaSe MAtTERs!
CALENDARS='carlos.fonseca@talkdesk.com'
...
then
	...
	osascript -e 'tell application "Keyboard Maestro Engine" to do script "R3C5 - Set No Meetings"'
...
##		 6 minutes =  360
  ...
  if [[ "$DIFF" -le "360" ]]
then
	osascript -e 'tell application "Keyboard Maestro Engine" to do script "R3C5 - Set Color Red"'

elif [[ "$DIFF" -le "660" ]]
then

	osascript -e 'tell application "Keyboard Maestro Engine" to do script "R3C5 - Set Color Orange"'

elif [[ "$DIFF" -le "960" ]]
then

	osascript -e 'tell application "Keyboard Maestro Engine" to do script "R3C5 - Set Color Yellow"'

elif [[ "$DIFF" -le "1860" ]]
then

	osascript -e 'tell application "Keyboard Maestro Engine" to do script "R3C5 - Set Color Blue"'

else

	osascript -e 'tell application "Keyboard Maestro Engine" to do script "R3C5 - Set Color Black"'
fi
